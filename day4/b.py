...
for assignment in lines:
    ...
    elf2end = int(elf2[1])
    if elf1start >= elf2start and elf1start <= elf2end:
        countFullyOverlappingElves += 1
        continue
    if elf1end >= elf2start and elf1end <= elf2end:
        countFullyOverlappingElves += 1
        continue
    if elf2start >= elf1start and elf2start <= elf1end:
        countFullyOverlappingElves += 1
        continue
    if elf2end >= elf1start and elf2end <= elf1end:
        countFullyOverlappingElves += 1
